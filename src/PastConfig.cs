...
namespace PlutoVetVisit
{
    ...
    public static class PastConfig
    {
        ...
        public static string Wave1 = "mutant_bullet_kin,mutant_bullet_kin,rat";
        public static string Wave2 = "mutant_bullet_kin,mutant_bullet_kin,parrot,parrot,rat";
        ...
        public static void Bind(ConfigFile cfg)
        {
            ...
            Wave1 = cfg.Bind("Waves", "Wave1", Wave1, "Ward wave 1: comma-separated enemy names (rat, parrot, mutant_bullet_kin) or GUIDs. Spawned at the side doors.").Value;
